...
<div id="zawartosc">
<!-- NEWS -->
<div class="taskbar"><a class="ataskbar">Lista wolnych apartamentów:</a></div>
<form action="status_ap.php">
...
try {
    ...
    try {
        $zapytanie = $polacz->prepare("SELECT * FROM pokaz_apartamenty WHERE STATUS = 'DOSTEPNY'");
        $zapytanie->execute();
